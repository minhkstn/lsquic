/*
 * Auto-generated by ./gen-verstrs.pl on Fri Apr 10 11:40:41 2020
 */
...
static const struct {
    ...
    {(1<<LSQVER_ID25), { "h3-25", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_ID25), { "h3-Q043", "h3-25", NULL }},
    {(1<<LSQVER_046)|(1<<LSQVER_ID25), { "h3-Q046", "h3-25", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_ID25), { "h3-Q043", "h3-Q046", "h3-25", NULL }},
    {(1<<LSQVER_050)|(1<<LSQVER_ID25), { "h3-Q050", "h3-25", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_050)|(1<<LSQVER_ID25), { "h3-Q043", "h3-Q050", "h3-25", NULL }},
    {(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID25), { "h3-Q046", "h3-Q050", "h3-25", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID25), { "h3-Q043", "h3-Q046", "h3-Q050", "h3-25", NULL }},
    ...
    {(1<<LSQVER_ID25)|(1<<LSQVER_ID27), { "h3-25", "h3-27", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_ID25)|(1<<LSQVER_ID27), { "h3-Q043", "h3-25", "h3-27", NULL }},
    {(1<<LSQVER_046)|(1<<LSQVER_ID25)|(1<<LSQVER_ID27), { "h3-Q046", "h3-25", "h3-27", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_ID25)|(1<<LSQVER_ID27), { "h3-Q043", "h3-Q046", "h3-25", "h3-27", NULL }},
    {(1<<LSQVER_050)|(1<<LSQVER_ID25)|(1<<LSQVER_ID27), { "h3-Q050", "h3-25", "h3-27", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_050)|(1<<LSQVER_ID25)|(1<<LSQVER_ID27), { "h3-Q043", "h3-Q050", "h3-25", "h3-27", NULL }},
    {(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID25)|(1<<LSQVER_ID27), { "h3-Q046", "h3-Q050", "h3-25", "h3-27", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID25)|(1<<LSQVER_ID27), { "h3-Q043", "h3-Q046", "h3-Q050", "h3-25", "h3-27", NULL }},
};
...
lsquic_get_h3_alpns (unsigned versions)
{
    ...
    versions &= ((1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID25)|(1<<LSQVER_ID27));
...
lsquic_alpn2ver (const char *alpn, size_t len)
{
    static const struct el {
        ...
        {sizeof("h3-25")-1,"h3-25", LSQVER_ID25},
