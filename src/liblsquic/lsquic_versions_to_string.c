/*
 * Auto-generated by /home/minh/HTTP3_QUIC/LSQUIC/lsquic_minh_kstn_branch/src/liblsquic/gen-verstrs.pl on Tue Jun 16 14:32:00 2020
 */
...
static const struct {
    ...
    {(1<<LSQVER_ID28), { "h3-28", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_ID28), { "h3-Q043", "h3-28", NULL }},
    {(1<<LSQVER_046)|(1<<LSQVER_ID28), { "h3-Q046", "h3-28", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_ID28), { "h3-Q043", "h3-Q046", "h3-28", NULL }},
    {(1<<LSQVER_050)|(1<<LSQVER_ID28), { "h3-Q050", "h3-28", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_050)|(1<<LSQVER_ID28), { "h3-Q043", "h3-Q050", "h3-28", NULL }},
    {(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID28), { "h3-Q046", "h3-Q050", "h3-28", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID28), { "h3-Q043", "h3-Q046", "h3-Q050", "h3-28", NULL }},
    {(1<<LSQVER_ID27)|(1<<LSQVER_ID28), { "h3-27", "h3-28", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_ID27)|(1<<LSQVER_ID28), { "h3-Q043", "h3-27", "h3-28", NULL }},
    {(1<<LSQVER_046)|(1<<LSQVER_ID27)|(1<<LSQVER_ID28), { "h3-Q046", "h3-27", "h3-28", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_ID27)|(1<<LSQVER_ID28), { "h3-Q043", "h3-Q046", "h3-27", "h3-28", NULL }},
    {(1<<LSQVER_050)|(1<<LSQVER_ID27)|(1<<LSQVER_ID28), { "h3-Q050", "h3-27", "h3-28", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_050)|(1<<LSQVER_ID27)|(1<<LSQVER_ID28), { "h3-Q043", "h3-Q050", "h3-27", "h3-28", NULL }},
    {(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID27)|(1<<LSQVER_ID28), { "h3-Q046", "h3-Q050", "h3-27", "h3-28", NULL }},
    {(1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID27)|(1<<LSQVER_ID28), { "h3-Q043", "h3-Q046", "h3-Q050", "h3-27", "h3-28", NULL }},
};
...
lsquic_get_h3_alpns (unsigned versions)
{
    ...
    versions &= ((1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_050)|(1<<LSQVER_ID27)|(1<<LSQVER_ID28));
...
lsquic_alpn2ver (const char *alpn, size_t len)
{
    static const struct el {
        ...
        {sizeof("h3-28")-1,"h3-28", LSQVER_ID28},
    };
    const struct el *el;
